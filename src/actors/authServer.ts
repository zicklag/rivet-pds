...
// import { schema } from "./authServer/schema";
// import migrations from "./authServer/drizzle/migrations";
...
export const authServer = actor({
      ...
      middleware: oauthMiddleware(
        new OAuthProvider({
          ...
          accountStore: {
            ...
            verifyHandleAvailability: function (
              handle: string,
            ): Awaitable<void> {
              throw new Error("Function not implemented.");
            },
          ...
          lexiconStore: {
            findLexicon: function (
              nsid: string,
            ): Awaitable<LexiconData | null> {
              throw new Error("Function not implemented.");
            },
  ...
  actions: {
    httpMiddleware: (c, ...args: Parameters<Middleware>) => {
      return c.vars.middleware(...args);
    },
  },
});

type Middleware = ReturnType<typeof oauthMiddleware>;
